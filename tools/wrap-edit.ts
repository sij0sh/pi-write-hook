// Edit wrapper: identical schema and description to native Pi edit.
...
export function createEditExecute(rt: MutationRuntime) {
  return async (
    toolCallId: string,
    ...
    return executeMutation("edit", params, call, rt);
  };
}
